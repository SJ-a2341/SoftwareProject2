...
#define _DUTY_NEU 1450 // 1500
#define _DUTY_MIN 700 // 1000

#define _SERVO_ANGLE_DIFF  1700  // Replace with |D - E| degree
#define _SERVO_SPEED       500  // servo speed

#define _BANGBANG_RANGE    300  // duty up and down for bangbang control

// Target Distance
#define _DIST_TARGET    300 // Center of the rail (unit:mm)
...
void loop()
{
  ...
  if (event_dist) {
    ...
    dist_filtered = volt_to_distance(ir_sensor_filtered(10, 0.2, 0));
...
float volt_to_distance(int a_value)
{
  ...
  return (6762.0 / (634.5 + -2.08*a_value +1.73E-03*a_value*a_value - 9) - 4.0) * 10.0;
}
